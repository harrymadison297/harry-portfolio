...
const LocationCard = () => {
  ...
  useEffect(() => {
    ...
    const globe = createGlobe(canvasRef.current, {
      ...
      markers: [{ location: [ 21.0285, 105.8048], size: 0.1 }],
      scale: 1.05,
      onRender: (state) => {
  ...
  return (
    <div className='shadow-feature-card dark:shadow-feature-card-dark relative flex h-60 flex-col gap-6 overflow-hidden rounded-xl p-4 lg:p-6'>
      <div className='flex items-center gap-2'>
        ...
        <h2 className='text-sm font-light'>Viet Nam</h2>
      </div>
      <div className='absolute inset-x-0 bottom-[-0px] mx-auto aspect-square h-[200px]'>
        <div
          style={{
            width: '100%',
            height: '100%',
